...
func (in *ConnectionPoolSpec) DeepCopyInto(out *ConnectionPoolSpec) { *out = *in }
func (in *ConnectionPoolSpec) DeepCopy() *ConnectionPoolSpec {
	if in == nil { return nil }
	out := new(ConnectionPoolSpec); in.DeepCopyInto(out); return out
}
...
func (in *HASpec) DeepCopy() *HASpec {
	if in == nil { return nil }
	out := new(HASpec); in.DeepCopyInto(out); return out
}
...
func (in *PostgresCluster) DeepCopy() *PostgresCluster {
	if in == nil { return nil }
	out := new(PostgresCluster); in.DeepCopyInto(out); return out
}
...
func (in *PostgresClusterList) DeepCopy() *PostgresClusterList {
	if in == nil { return nil }
	out := new(PostgresClusterList); in.DeepCopyInto(out); return out
}
...
func (in *PostgresClusterSpec) DeepCopy() *PostgresClusterSpec {
	if in == nil { return nil }
	out := new(PostgresClusterSpec); in.DeepCopyInto(out); return out
}
...
func (in *PostgresClusterStatus) DeepCopy() *PostgresClusterStatus {
	if in == nil { return nil }
	out := new(PostgresClusterStatus); in.DeepCopyInto(out); return out
}
