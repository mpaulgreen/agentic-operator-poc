...
type MongoClusterSpec struct {
	...
	// Sharding defines the optional sharding configuration.
	// +optional
	Sharding *ShardingSpec `json:"sharding,omitempty"`

	// MaxConnections defines the maximum number of incoming connections.
	// +optional
...
// ShardingSpec defines sharding configuration for MongoDB.
type ShardingSpec struct {
	// Enabled indicates whether sharding is active.
	// +kubebuilder:default=false
	Enabled bool `json:"enabled,omitempty"`
	...
	// ConfigServerReplicas is the number of config server replicas.
	// +kubebuilder:validation:Minimum=1
	// +kubebuilder:validation:Maximum=5
	// +kubebuilder:default=3
	ConfigServerReplicas int32 `json:"configServerReplicas,omitempty"`
}
...
type MongoClusterStatus struct {
	...
	// ShardingEnabled indicates whether sharding is currently active.
